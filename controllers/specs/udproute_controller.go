...
//+kubebuilder:rbac:groups=specs.smi-spec.io,resources=udproutes,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=specs.smi-spec.io,resources=udproutes/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=specs.smi-spec.io,resources=udproutes/finalizers,verbs=update
