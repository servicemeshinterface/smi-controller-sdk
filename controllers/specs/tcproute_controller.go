...
//+kubebuilder:rbac:groups=specs.smi-spec.io,resources=tcproutes,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=specs.smi-spec.io,resources=tcproutes/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=specs.smi-spec.io,resources=tcproutes/finalizers,verbs=update
